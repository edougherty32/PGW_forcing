## This set of scripts generate PGW forcing from the ensemble mean of LENS2 that is added to ERA5 reanalysis data. 
...
- Only use the files output ending in *final.grb and *zaxis1.grb (for soil files only) for your final forcing. 
...
- Only use the files output ending in *final.grb for your final forcing. 
